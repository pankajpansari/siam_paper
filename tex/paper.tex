...
\mysection{Accurate Submodular Extensions from LP Relaxations}
...
First, let us consider the IP formulation of the MAP problem for our diversity model. Using the same set of indicator variables $y_{ai} = \{0, 1\}$ as for the Potts model, which are binary now, the clique potential $\phi({\bf x_c})$ can be represented as
