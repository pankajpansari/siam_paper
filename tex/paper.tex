...
\label{eq:t-lp}
\end{align}
The set $\Delta$ is the same domain as defined in equation (\ref{eq:delta}). We
rewrite this LP relaxation using indicator variables $z_{ai}$ for all labels
and meta-labels as
\begin{align}
    \text{(T-LP-FULL)} &\quad \min \widetilde{E}({\bf z}) \nonumber \\
