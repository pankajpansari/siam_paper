...
log-partition ~\citep{koltun2011efficient}. Finally, we also obtain the
submodular extension based on the LP relaxation for a higher-order version of
the Potts model that captures useful image statistics.  We show that the quality of our
