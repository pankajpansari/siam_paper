...
\headers{LP-based Submodular Extensions for Marginal Estimation}{P. Pansari, C. Russell, and M. P. Kumar}

% Title. If the supplement option is on, then "Supplementary Material"
% is automatically inserted before the title.
\title{LP-based Submodular Extensions for Marginal Estimation\thanks{Submitted to the editors 5th January, 2019. A preliminary version of the paper apperared in the conference proceedings of AISTATS, 2018.
